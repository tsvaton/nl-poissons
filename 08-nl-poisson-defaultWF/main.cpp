...
int main(int argc, char* argv[])
{
  ...
  CustomNonlinearBulk eta(gama, delta);
  Hermes2DFunction<double> src(-heat_src);

//  CustomWeakFormDiffusion wf("Mat", &lambda, &eta, &src);
  CustomWeakFormDiffusion wf("Mat", &lambda, new Hermes2DFunction<double>(2.0), &src);

/* 
//  Experimental code!!! 
//  DefaultWeakFormPoisson<double> wf(HERMES_ANY, &lambda, &src);
//  CustomWeakFormDiffusion wf("Mat", new Hermes1DFunction<double>(1.0), new Hermes2DFunction<double>(3.0), new Hermes2DFunction<double>(-1.0));
*/
